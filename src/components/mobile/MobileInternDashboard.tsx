...
function MobileReferralCodeInput({ user, queryClient }: { user: any; queryClient: any }) {
  ...
  if (!showInput) {
    return (
      <button onClick={() => setShowInput(true)} className="flex items-center gap-1.5 text-xs text-primary hover:underline">
