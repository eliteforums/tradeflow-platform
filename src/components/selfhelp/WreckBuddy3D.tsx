...
/* ── Desktop 3D version ── */
let WreckBuddy3DCanvas: React.ComponentType<WreckBuddy3DProps> | null = null;
...
try {
  ...
  WreckBuddy3DCanvas = function ({ hitCount, onHit }: WreckBuddy3DProps) {
    return (
  ...
  WreckBuddy3DCanvas = null;
}

export default function WreckBuddy3D(props: WreckBuddy3DProps) {
  const isMobile = useIsMobile();
  if (isMobile || !WreckBuddy3DCanvas) return <WreckBuddy2D {...props} />;
  return <WreckBuddy3DCanvas {...props} />;
}
